...
class StoryBoardBuilder:
    ...
    def SaveScenarioPart(self):
        ...
        StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Border"] = self.Border.get("1.0", tkinter.END).strip("\n")
        StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["TextBorder"] = self.TextBorder.get("1.0", tkinter.END).strip("\n")
        StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["FaceBorder"] = self.FaceBorder.get("1.0", tkinter.END).strip("\n")
    ...
    def SetDataEntry(self):
        ...
        if self.ScenarioActs.get() == "Info":
            self.Name = tkinter.Text(self.window, height=1)
            self.Name.insert("1.0", chars=StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Name"])
            self.Name.grid(column=4, row=2)
            self.NameLabel = tkinter.Label(self.window, text="Name")
            self.NameLabel.grid(column=3, row=2)


            self.Description = tkinter.Text(self.window, height=4)
            self.Description.insert("1.0",chars=StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Description"])
            ...
            if StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["BackGround"] is None or "":
                ...
                self.BackGround = tkinter.Text(self.window, height=1)
                self.BackGround.insert("1.0", chars=StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["BackGround"])
                self.BackGround.grid(column=4, row=6)
                self.BackGroundLabel = tkinter.Label(self.window, text="BackGround")
                self.BackGroundLabel.grid(column=3, row=6)

            if StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Face"] is None or "":
                self.Face = tkinter.Text(self.window, height=1)
            ...
            if StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Text"] is None or "":
                self.Text = tkinter.Text(self.window, height=4)
            ...
            if StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Border"] is None or "":
                self.Border = tkinter.Text(self.window, height=1)
            ...
            if StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["TextBorder"] is None or "":
                self.TextBorder = tkinter.Text(self.window, height=1)
            ...
            if StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["FaceBorder"] is None or "":
                self.FaceBorder = tkinter.Text(self.window, height=1)
                ...
                self.FaceBorder = tkinter.Text(self.window, height=1)
                self.FaceBorder.insert("1.0", chars=StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["FaceBorder"])
                self.FaceBorder.grid(column=4, row=11)
                self.FaceBorderLabel = tkinter.Label(self.window, text="Face Border")
                self.FaceBorderLabel.grid(column=3, row=11)
            self.ChoiceDict={}
    ...
    def MakeScenario(self):
        ...
        StoryDB[self.NewScenarioName.get("1.0", tkinter.END).strip("\n")] = {"Info":
                    {"Name": self.NewScenarioName.get("1.0", tkinter.END).strip("\n"),
                     "Description": self.NewScenarioDescription.get("1.0", tkinter.END).rstrip("\n")}}
        self.top.destroy()
        self.SaveStoryDB(StoryDB)
        self.SetScenarios()
    ...
    def UpdateChoiceDict(self):
        ...
        for each in StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Choices"]:
            ...
            "Requirement": StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Choices"][each]["Requirement"],
            "Price": StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Choices"][each]["Price"],
            "Destination": StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Choices"][each]["Destination"],
            "Color": StoryDB[self.CurrentScenario.get()][self.ScenarioActs.get()]["Choices"][each]["Color"]}

    def UpdateChoiceDisply(self):
        self.ChoiceRow=11

        ChoiceName = tkinter.Text(self.window, height=1)
        ...
        ChoiceReward = tkinter.Text(self.window, height=1)
        ...
        ChoiceRequirement = tkinter.Text(self.window, height=1)
        if self.ChoiceDict[self.CurrentChoices.get()]["Reward"] is None or "":
        ...
        ChoicePrice = tkinter.Text(self.window, height=1)
        if self.ChoiceDict[self.CurrentChoices.get()]["Reward"] is None or "":
        ...
        ChoiceDestination = tkinter.Text(self.window, height=1)
        ...
        ChoiceColor = tkinter.Text(self.window, height=1)
    ...
    def AddChoice(self):
        ...
        self.NewColor = tkinter.Entry(self.top, width=25)
        self.NewColor.pack()
    ...
    def AddPart(self):
        StoryDB = ReloadStory()
        StoryDB[self.CurrentScenario.get()][self.NewPartName.get()] = {"Template" : "800x200R", "BackGround" : None, "Face" : None,
                                                                      "Text" : None,"Border" : None,"TextBorder" : None,
                                                                      "FaceBorder": None,"TextBorder" : None,
                            "Choices":{"Next":{"Reward": None,"Requirement": None,"Price": None,"Destination": "10","Color": "green"}}}
